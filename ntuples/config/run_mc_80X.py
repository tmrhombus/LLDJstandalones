...
#process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(12000) )##Number of events -1 does all
...
process.source = cms.Source("PoolSource",
 ...
 '/store/mc/RunIISummer16MiniAODv2/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext2-v1/100000/00099D43-77ED-E611-8889-5065F381E1A1.root',
  ...
  #'/store/mc/RunIISummer16MiniAODv2/WWTo2L2Nu_13TeV-powheg/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/80000/08E155A9-FAB6-E611-92BF-00259073E45E.root'
   ...
   #'file:/uscms_data/d3/tmperry/LLDJ_slc6_530_CMSSW_8_0_26_patch2/src/LLDJstandalones/roots/miniAOD/DY_00099D43-77ED-E611-8889-5065F381E1A1.root',
...
#process.TFileService = cms.Service("TFileService", fileName = cms.string('lldjntuple_mcv2_DY.root'));
#process.TFileService = cms.Service("TFileService", fileName = cms.string('lldjntuple_mcv3_MS40_cTauS100.root'));
process.TFileService = cms.Service("TFileService", fileName = cms.string('lldjntuple_mc_DY.root'));
#process.TFileService = cms.Service("TFileService", fileName = cms.string('lldjntuple_mc_MS40_cTauS100.root'));
