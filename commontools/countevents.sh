...
countalist "SingleElectron_B_2"                   ${xcSingleElectron}                    
countalist "SingleElectron_C"                     ${xcSingleElectron}                    
countalist "SingleElectron_D"                     ${xcSingleElectron}                    
countalist "SingleElectron_E"                     ${xcSingleElectron}                    
countalist "SingleElectron_G"                     ${xcSingleElectron}                    
countalist "SingleElectron_H_3"                   ${xcSingleElectron}                    
#countalist "SingleMuon"                         ${xcSingleMuon}                        
countalist "SingleMuon_B_2"                       ${xcSingleMuon}                        
countalist "SingleMuon_C"                         ${xcSingleMuon}                        
countalist "SingleMuon_D"                         ${xcSingleMuon}                        
countalist "SingleMuon_E"                         ${xcSingleMuon}                        
countalist "SingleMuon_F"                         ${xcSingleMuon}                        
countalist "SingleMuon_G"                         ${xcSingleMuon}                        
countalist "SingleMuon_H"                         ${xcSingleMuon}                        
#countalist "SinglePhoton"                       ${xcSinglePhoton}                        
countalist "SinglePhoton_B_2"                     ${xcSinglePhoton}                        
countalist "SinglePhoton_C"                       ${xcSinglePhoton}                        
countalist "SinglePhoton_D"                       ${xcSinglePhoton}                        
countalist "SinglePhoton_E"                       ${xcSinglePhoton}                        
countalist "SinglePhoton_F"                       ${xcSinglePhoton}                        
countalist "SinglePhoton_G"                       ${xcSinglePhoton}                        
countalist "SinglePhoton_H"                       ${xcSinglePhoton}                        
