...
makeasubmitdir () {
 ...
 printf "Transfer_Input_Files = ${CMSSW_BASE}/src/LLDJstandalones/analyzers/runanalyzer.exe,${CMSSW_BASE}/src/LLDJstandalones/lists/$1.list,${CMSSW_BASE}/src/LLDJstandalones/lists/$1.info,${CMSSW_BASE}/src/LLDJstandalones/analyzers/puWeights_DoubleEG_69200.root,${CMSSW_BASE}/src/LLDJstandalones/analyzers/puWeights_MuonEG_69200.root,${CMSSW_BASE}/src/LLDJstandalones/analyzers/puWeights_SinglePhoton_69200.root,${CMSSW_BASE}/src/LLDJstandalones/analyzers/puWeights_DoubleMu_69200.root,${CMSSW_BASE}/src/LLDJstandalones/analyzers/egammaEffi_MoriondBH_eleTight.root,${CMSSW_BASE}/src/LLDJstandalones/analyzers/egammaEffi_MoriondBH_eleMedium.root,${CMSSW_BASE}/src/LLDJstandalones/analyzers/egammaEffi_MoriondBH_eleLoose.root,${CMSSW_BASE}/src/LLDJstandalones/analyzers/feff_ZH.root\n" >> submitfile
