...
Bool_t analyzer_signal::initJetHistograms()
{
 ...
 for(unsigned int i=0; i<selbinnames.size(); ++i){
  for(unsigned int j=0; j<jetmultnames.size(); ++j){
   ...
   h_jetPt                       [i][j] = initSingleHistogramTH1F(  hname_jetPt                      , "jetPt                     " , 50, 0, 300 );   
   h_jetEn                       [i][j] = initSingleHistogramTH1F(  hname_jetEn                      , "jetEn                     " , 50, 0, 30 );   
   ...
   h_jetRawPt                    [i][j] = initSingleHistogramTH1F(  hname_jetRawPt                   , "jetRawPt                  " , 50, 0, 300 );      
   h_jetRawEn                    [i][j] = initSingleHistogramTH1F(  hname_jetRawEn                   , "jetRawEn                  " , 50, 0, 300 );      
   h_jetMt                       [i][j] = initSingleHistogramTH1F(  hname_jetMt                      , "jetMt                     " , 50, 0, 300 );   
   h_jetArea                     [i][j] = initSingleHistogramTH1F(  hname_jetArea                    , "jetArea                   " , 10, 0, 10 );     
   h_jetLeadTrackPt              [i][j] = initSingleHistogramTH1F(  hname_jetLeadTrackPt             , "jetLeadTrackPt            " , 50, 0, 50 );            
   h_jetLeadTrackEta             [i][j] = initSingleHistogramTH1F(  hname_jetLeadTrackEta            , "jetLeadTrackEta           " , 10, -5, 5 );             
   h_jetLeadTrackPhi             [i][j] = initSingleHistogramTH1F(  hname_jetLeadTrackPhi            , "jetLeadTrackPhi           " , 10, -5, 5 );             
   h_jetLepTrackPID              [i][j] = initSingleHistogramTH1F(  hname_jetLepTrackPID             , "jetLepTrackPID            " , 10, 0, 10 );            
   h_jetLepTrackPt               [i][j] = initSingleHistogramTH1F(  hname_jetLepTrackPt              , "jetLepTrackPt             " , 50, 0, 50 );           
   h_jetLepTrackEta              [i][j] = initSingleHistogramTH1F(  hname_jetLepTrackEta             , "jetLepTrackEta            " , 10, -5, 5 );            
   h_jetLepTrackPhi              [i][j] = initSingleHistogramTH1F(  hname_jetLepTrackPhi             , "jetLepTrackPhi            " , 10, -5, 5 );            
   ...
   h_jetPartonID                 [i][j] = initSingleHistogramTH1F(  hname_jetPartonID                , "jetPartonID               " , 50, 0, 50 );         
   h_jetHadFlvr                  [i][j] = initSingleHistogramTH1F(  hname_jetHadFlvr                 , "jetHadFlvr                " , 50, 0, 50 );        
   h_jetGenJetEn                 [i][j] = initSingleHistogramTH1F(  hname_jetGenJetEn                , "jetGenJetEn               " , 50, 0, 50 );         
   h_jetGenJetPt                 [i][j] = initSingleHistogramTH1F(  hname_jetGenJetPt                , "jetGenJetPt               " , 50, 0, 50 );         
   h_jetGenJetEta                [i][j] = initSingleHistogramTH1F(  hname_jetGenJetEta               , "jetGenJetEta              " , 50, 0, 50 );          
   h_jetGenJetPhi                [i][j] = initSingleHistogramTH1F(  hname_jetGenJetPhi               , "jetGenJetPhi              " , 50, 0, 50 );          
   h_jetGenPartonID              [i][j] = initSingleHistogramTH1F(  hname_jetGenPartonID             , "jetGenPartonID            " , 50, 0, 50 );            
   h_jetGenEn                    [i][j] = initSingleHistogramTH1F(  hname_jetGenEn                   , "jetGenEn                  " , 50, 0, 50 );      
   h_jetGenPt                    [i][j] = initSingleHistogramTH1F(  hname_jetGenPt                   , "jetGenPt                  " , 50, 0, 50 );      
   h_jetGenEta                   [i][j] = initSingleHistogramTH1F(  hname_jetGenEta                  , "jetGenEta                 " , 50, 0, 50 );       
   h_jetGenPhi                   [i][j] = initSingleHistogramTH1F(  hname_jetGenPhi                  , "jetGenPhi                 " , 50, 0, 50 );       
   h_jetGenPartonMomID           [i][j] = initSingleHistogramTH1F(  hname_jetGenPartonMomID          , "jetGenPartonMomID         " , 50, 0, 50 );               
   h_AK8JetPt                    [i][j] = initSingleHistogramTH1F(  hname_AK8JetPt                   , "AK8JetPt                  " , 50, 0, 50 );      
   h_AK8JetEn                    [i][j] = initSingleHistogramTH1F(  hname_AK8JetEn                   , "AK8JetEn                  " , 50, 0, 50 );      
   h_AK8JetRawPt                 [i][j] = initSingleHistogramTH1F(  hname_AK8JetRawPt                , "AK8JetRawPt               " , 50, 0, 50 );         
   h_AK8JetRawEn                 [i][j] = initSingleHistogramTH1F(  hname_AK8JetRawEn                , "AK8JetRawEn               " , 50, 0, 50 );         
   h_AK8JetEta                   [i][j] = initSingleHistogramTH1F(  hname_AK8JetEta                  , "AK8JetEta                 " , 50, 0, 50 );       
   h_AK8JetPhi                   [i][j] = initSingleHistogramTH1F(  hname_AK8JetPhi                  , "AK8JetPhi                 " , 50, 0, 50 );       
   h_AK8JetMass                  [i][j] = initSingleHistogramTH1F(  hname_AK8JetMass                 , "AK8JetMass                " , 50, 0, 50 );        
