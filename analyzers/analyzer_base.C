...
//   phoIDMVA = 0;
   ...
   //AOD_muPassHipID = 0;
   AOD_muPassTightID = 0;
   //AOD_muNumberOfMissingInnerHits = 0;
   //AOD_muNumberOfMissingMiddleHits = 0;
   //AOD_muNumberOfMissingOuterHits = 0;
   //AOD_muNumberOfMatchedStations = 0;
   //AOD_muNumberOfValidPixelHits = 0;
   //AOD_muTrackerLayersWithMeasurement = 0;
...
//   fChain->SetBranchAddress("phoIDMVA", &phoIDMVA, &b_phoIDMVA);
   ...
   //fChain->SetBranchAddress("AOD_eleSCEn", &AOD_eleSCEn, &b_AOD_eleSCEn);
   //fChain->SetBranchAddress("AOD_eleSCEta", &AOD_eleSCEta, &b_AOD_eleSCEta);
   ...
   //fChain->SetBranchAddress("AOD_elePFdBetaIsolationDiff", &AOD_elePFdBetaIsolationDiff, &b_AOD_elePFdBetaIsolationDiff);
   ...
   //fChain->SetBranchAddress("AOD_muIDbit", &AOD_muIDbit, &b_AOD_muIDbit);
   fChain->SetBranchAddress("AOD_muPassLooseID", &AOD_muPassLooseID, &b_AOD_muPassLooseID);
   //fChain->SetBranchAddress("AOD_muPassHipID", &AOD_muPassHipID, &b_AOD_muPassHipID);
   fChain->SetBranchAddress("AOD_muPassTightID", &AOD_muPassTightID, &b_AOD_muPassTightID);
   //fChain->SetBranchAddress("AOD_muNumberOfMissingInnerHits", &AOD_muNumberOfMissingInnerHits, &b_AOD_muNumberOfMissingInnerHits);
   //fChain->SetBranchAddress("AOD_muNumberOfMissingMiddleHits", &AOD_muNumberOfMissingMiddleHits, &b_AOD_muNumberOfMissingMiddleHits);
   //fChain->SetBranchAddress("AOD_muNumberOfMissingOuterHits", &AOD_muNumberOfMissingOuterHits, &b_AOD_muNumberOfMissingOuterHits);
   //fChain->SetBranchAddress("AOD_muNumberOfMatchedStations", &AOD_muNumberOfMatchedStations, &b_AOD_muNumberOfMatchedStations);
   //fChain->SetBranchAddress("AOD_muNumberOfValidPixelHits", &AOD_muNumberOfValidPixelHits, &b_AOD_muNumberOfValidPixelHits);
   //fChain->SetBranchAddress("AOD_muTrackerLayersWithMeasurement", &AOD_muTrackerLayersWithMeasurement, &b_AOD_muTrackerLayersWithMeasurement);
