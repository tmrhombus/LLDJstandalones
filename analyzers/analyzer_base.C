...
//   fChain->SetBranchAddress("phoMapPFChWorstIso", &phoMapPFChWorstIso, &b_phoMapPFChWorstIso);
   ...
   fChain->SetBranchAddress("AODPFJetAlphaMax2", &AODPFJetAlphaMax2_, &b_AODPFJetAlphaMax2_);
   fChain->SetBranchAddress("AODPFJetAlphaMaxPrime", &AODPFJetAlphaMaxPrime_, &b_AODPFJetAlphaMaxPrime_);
   fChain->SetBranchAddress("AODPFJetAlphaMaxPrime2", &AODPFJetAlphaMaxPrime2_, &b_AODPFJetAlphaMaxPrime2_);
   fChain->SetBranchAddress("AODPFJetBeta", &AODPFJetBeta_, &b_AODPFJetBeta_);
   fChain->SetBranchAddress("AODPFJetBeta2", &AODPFJetBeta2_, &b_AODPFJetBeta2_);
   ...
   fChain->SetBranchAddress("AODPFchsJetAlphaMax2", &AODPFchsJetAlphaMax2_, &b_AODPFchsJetAlphaMax2_);
   fChain->SetBranchAddress("AODPFchsJetAlphaMaxPrime", &AODPFchsJetAlphaMaxPrime_, &b_AODPFchsJetAlphaMaxPrime_);
   fChain->SetBranchAddress("AODPFchsJetAlphaMaxPrime2", &AODPFchsJetAlphaMaxPrime2_, &b_AODPFchsJetAlphaMaxPrime2_);
   fChain->SetBranchAddress("AODPFchsJetBeta", &AODPFchsJetBeta_, &b_AODPFchsJetBeta_);
   fChain->SetBranchAddress("AODPFchsJetBeta2", &AODPFchsJetBeta2_, &b_AODPFchsJetBeta2_);
